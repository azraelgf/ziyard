 ...
 */
    ...
    (() => {
        ...
        const inputMasks = document.querySelectorAll(".js-tel");
        ...
        function initSliders() {
            if (document.querySelector(".about-partners__body")) new Swiper(".about-partners__body", {
        ...
        function headerScroll() {
            ...
            const startPoint = header.dataset.scroll ? header.dataset.scroll : 0;
        ...
        if (document.querySelector(".btn-up")) {
            ...
            window.addEventListener("scroll", (function() {
                if (window.scrollY > 1e3) btnUp.classList.add("_btn-up-active"); else btnUp.classList.remove("_btn-up-active");
            }));
        }
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            document.querySelectorAll(".has-submenu").forEach((item => {
                item.addEventListener("mouseenter", (function() {
                    submenu.classList.add("_submenu-active");
                }));
                item.addEventListener("click", (function(event) {
                    event.stopPropagation();
                    submenu.classList.toggle("_submenu-active");
                }));
            }));
            document.addEventListener("mouseover", (function(event) {
                const target = event.target;
                if (!target.closest(".has-submenu") && !target.closest(".header__submenu")) submenu.classList.remove("_submenu-active");
            }));
        }));
        window["FLS"] = false;
        addLoadedClass();
